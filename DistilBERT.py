...
def train_model(model, train_loader, test_loader, num_epochs=3):
    ...
    for epoch in range(num_epochs):
        ...
        print(f'Epoch {epoch + 1}/{num_epochs} - LR: {lr:.9f} - '
...
def main():
    ...
    # Save the model
    torch.save(model.state_dict(), 'Twitter Sentiment Analysis/DistilBERT_Model.pth')
    print("Model saved.")
    ...
    plt.tight_layout()
    plt.savefig('Twitter Sentiment Analysis/Confusion_Matrix_Distill.png')
